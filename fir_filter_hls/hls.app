<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="fir_filter_hls" ideType="classic" top="fir_filter">
    ...
    <files>
        ...
        <file name="../../tb/fir_ref.h" sc="0" tb="1" cflags="-Wno-unknown-pragmas" csimflags="" blackbox="false"/>
        <file name="../../tb/fir_ref.cpp" sc="0" tb="1" cflags="-I../../tb -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
