...
`define TV_IN_in_stream_TDATA "../tv/cdatafile/c.fir_filter.autotvin_in_stream_V_data_V.dat"
`define INGRESS_STATUS_in_stream_TDATA "../tv/stream_size/stream_ingress_status_in_stream_V_data_V.dat"
`define TV_IN_in_stream_TKEEP "../tv/cdatafile/c.fir_filter.autotvin_in_stream_V_keep_V.dat"
`define INGRESS_STATUS_in_stream_TKEEP "../tv/stream_size/stream_ingress_status_in_stream_V_keep_V.dat"
`define TV_IN_in_stream_TSTRB "../tv/cdatafile/c.fir_filter.autotvin_in_stream_V_strb_V.dat"
`define INGRESS_STATUS_in_stream_TSTRB "../tv/stream_size/stream_ingress_status_in_stream_V_strb_V.dat"
`define TV_IN_in_stream_TLAST "../tv/cdatafile/c.fir_filter.autotvin_in_stream_V_last_V.dat"
...
module AESL_axi_s_in_stream (
    ...
    fifo #(128, 32) fifo_in_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(128, 4) fifo_in_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(128, 4) fifo_in_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(128, 1) fifo_in_stream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_in_stream_TVALID_temp = ~(in_stream_TDATA_empty || in_stream_TKEEP_empty || in_stream_TSTRB_empty || in_stream_TLAST_empty);
